<x-layouts::auth :title="__('Log in')">
    <div class="flex flex-col gap-6">
        ...
        <a href="{{ route('auth.google.redirect') }}"
           class="flex items-center justify-center gap-3 h-11 border border-black dark:border-white text-sm font-medium hover:bg-black hover:text-white dark:hover:bg-white dark:hover:text-black transition-colors">
        ...
        <div class="flex items-center gap-3 text-xs uppercase tracking-widest text-zinc-400 dark:text-zinc-600">
            <span class="flex-1 border-t border-zinc-200 dark:border-zinc-700"></span>
            {{ __('or') }}
            <span class="flex-1 border-t border-zinc-200 dark:border-zinc-700"></span>
        </div>
